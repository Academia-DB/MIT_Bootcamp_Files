...
import AppContext from "../components_bkp/context";
import Home from "./index"
import Layout from "../components_bkp/layout"
...
function MyApp(props){
  ...
  return (
    <AppContext.Provider value={{cart:state.cart, addItem: addItem, removeItem: removeItem,isAuthenticated:isAuthenticated,user:newUser.user,setUser: setUser}}>
      <Head>
        <link
          rel="stylesheet"
